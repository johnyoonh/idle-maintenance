...
cp "$SRC_DIR"/{activity_intelligence.py,maintenance_core.py,process_identity.py,process_sampling.py,process_triage.py,process_review.py,prompt_session.py,review_ui.py,resource_monitor.py,storage_cleanup_core.py,disk_activity.py,maint.py,shortcut_review.py,maintenance_status_extended.py} "$RES_DIR/"
