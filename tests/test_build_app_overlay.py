...
class BuildAppOverlayTests(unittest.TestCase):
    ...
    def test_overlay_adds_native_visual_hierarchy_and_actions(self):
        ...
        self.assertIn('NSMenu(title: "Review Shortcuts")', result)
        self.assertIn('withTitle: "Keyboard Shortcuts…"', result)
        self.assertIn('withTitle: "Apple Shortcuts…"', result)
        ...
        self.assertIn("reviewAppleShortcuts", result)
